        ...
        <section className="flex flex-col items-center justify-center my-5">
            ...
            <form action="">
                ...
                <div className="grid grid-cols-1">
                    ...
                    <InputText placeholder="Ex: tag1, tag2..."/>
                </div>
                    ...
                    <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                        <div className="text-center">
                            <svg className="mx-auto h-12 w-12 text-gray-300" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                                <path fill-rule="evenodd" d="M1.5 6a2.25 2.25 0 012.25-2.25h16.5A2.25 2.25 
                                ...
                                1.125 0 01-2.25 0z" clip-rule="evenodd"></path>
                            </svg>
                            <div className="mt-4 flex text-sm leading-6 text-gray-600">
                                <label htmlFor="file-upload" className="relative cursor-pointer rrounded-md bg-white font-semibold text-indigo-600">
